...
//    if(!( (*(LED) == oldLED[0] && *(LED+1) == oldLED[1]) || (old_color.r == current_color.r && old_color.g == current_color.g && old_color.b == current_color.b )) )
 //   if( (*(LED) != oldLED[0] || *(LED+1) != oldLED[1]) || old_color.r != current_color.r || old_color.g != current_color.g || old_color.b != current_color.b ) 
    J1939.Transmit(0xFF75, 0x06, 0x87, 0xFF, &payload_keys_1_2[0], 8); //delay(100);
...
void setup()
{
    ...
    attachInterrupt(digitalPinToInterrupt(15),CR1301.CAN_receive(&CR1301.joystick_keys), CHANGE);
